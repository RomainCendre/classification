...
ViewsTools.write(SignalsViews.analysis_relation(inputs,  {'datum': 'Scale', 'wavelength': 'Wavelength', 'label_encode': 'Label'}, mode='Anova'), 'C:\\Users\\Romain\\Desktop\\analysis_ratio.pdf')
