...
from Classification.SpectrumClassification import SpectraClassifier
from IO.SpectrumIO import SpectrumReader, SpectrumWriter
from Parameter.SpectrumParameter import NeckParameters, ClassificationProcess

# Read spectra data
spectra_patients = SpectrumReader(';').read_table(NeckParameters.get_patients_path())
spectra_temoins = SpectrumReader(';').read_table(NeckParameters.get_temoins_path())
spectra_full = spectra_patients+spectra_temoins
